...
2. [구현 순서](docs/implementation-plan.md): 첫 작업과 단계별 완료 기준.
3. [하네스 설계](docs/harness-design.md): 대용량 저장·조회·취소·복구 흐름.
4. [데이터 명세](docs/data-model.md), [포맷 명세](docs/parser-format.md), [검증 기준](docs/testing.md).
